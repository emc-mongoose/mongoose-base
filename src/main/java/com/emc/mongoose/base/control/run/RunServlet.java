...
public class RunServlet extends HttpServlet {
	...
	static Config mergeIncomingWithLocalConfig(
		...
		if (defaultsPart == null) {
			...
			Loggers.MSG.debug(
				"Merging the configs: (1) stepId/auto = {}/{}, (2) stepId/auto = {}/{}",
				aggregatedConfigWithArgs.val("load-step-id"), aggregatedConfigWithArgs.val("load-step-idAutoGenerated"),
				configIncoming.val("load-step-id"), configIncoming.val("load-step-idAutoGenerated")
			);
