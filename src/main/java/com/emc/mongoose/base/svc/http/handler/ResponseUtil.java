...
public interface ResponseUtil {
	...
	static void respondContent(final ChannelHandlerContext ctx, final ByteBuf content, final String contentType) {
		final FullHttpResponse resp = new DefaultFullHttpResponse(HTTP_1_1, OK, content);
